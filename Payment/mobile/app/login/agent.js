  ...
  return (
    ...
    >
      ...
      <View className="items-center mb-10">
        ...
        <Text className="text-3xl font-bold text-white">Agent Portal</Text>
        <Text className="text-slate-400 mt-2">Secure access for top-ups</Text>
      </View>
      ...
      <View className="space-y-4">
        ...
        >
          <Text className="text-white text-center text-lg font-bold">Login to Agent Panel</Text>
        </TouchableOpacity>
      </View>
    </KeyboardAvoidingView>
  );
